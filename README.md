...
El servicio se encuentra operativo y accesible públicamente, sirviendo el contenido estático a través de un contenedor Nginx orquestado.

Proyecto realizado como parte de formación intensiva en DevOps.
